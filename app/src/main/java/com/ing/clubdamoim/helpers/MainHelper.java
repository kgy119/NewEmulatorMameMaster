...
package com.ing.clubdamoim.helpers;
...
import com.ing.clubdamoim.Emulator;
import com.ing.clubdamoim.MAME4droid;
import com.ing.clubdamoim.R;
import com.ing.clubdamoim.WebHelpActivity;
import com.ing.clubdamoim.input.ControlCustomizer;
import com.ing.clubdamoim.input.GameController;
import com.ing.clubdamoim.input.InputHandler;
import com.ing.clubdamoim.input.TouchController;
import com.ing.clubdamoim.prefs.UserPreferences;
import com.ing.clubdamoim.views.IEmuView;
import com.ing.clubdamoim.views.InputView;
...
public class MainHelper {
    ...
    public String getLibDir() {
        ...
        try {
            ...
            e.printStackTrace();
            lib_dir = "/data/data/com.ing.clubdamoim/lib";
        }
        return lib_dir;
    }
...
*/
    ...
    public void showHelp() {
        ...
        if (mm.getMainHelper().isAndroidTV()) {
            mm.getDialogHelper()
                    .setInfoMsg(
                            "When MAME4droid is first run, it will create a folder structure for you on the internal memory of your Android device. This folder contains all the other folders MAME uses as well as some basic configuration files."
                                    + "Since MAME4droid does not come with game ROM files, you will need to copy them to (You can change it in options to external storage if your device allows it) '/storage/emulated/0/Android/media/com.ing.clubdamoim/roms' folder (" +
			...
			.setInfoMsg(
					"When MAME4droid is first run, it will create a folder structure for you on the internal memory of your Android device. This folder contains all the other folders MAME uses as well as some basic configuration files."
							+ "Since MAME4droid does not come with game ROM files, you will need to copy them to the '/sdcard/MAME4droid/roms' or 'Android/data/com.ing.clubdamoim/files/roms' folder (" +
