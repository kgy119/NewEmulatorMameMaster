package com.ingcorp.webhard.service;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String title = remoteMessage.getNotification() != null ?
                remoteMessage.getNotification().getTitle() : "MAME4droid";
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "MAME Emulator";
            String description = "MAME4droid 알림";
    ...
    private void showNotification(String title, String body) {
        ...
        Intent intent = new Intent(this, com.ingcorp.webhard.SplashActivity.class);
