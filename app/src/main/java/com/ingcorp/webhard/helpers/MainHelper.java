...
import com.ingcorp.webhard.WebHelpActivity;
...
import com.ingcorp.webhard.prefs.UserPreferences;
import com.ingcorp.webhard.widgets.WarnWidget;
...
public class MainHelper {
    ...
    public String getLibDir() {
        ...
        try {
            ...
            e.printStackTrace();
            lib_dir = "/data/data/com.ingcorp.webhard/lib";
        }
        return lib_dir;
    }
...
*/
    ...
    public void showHelp() {
        ...
        if (mm.getMainHelper().isAndroidTV()) {
            mm.getDialogHelper()
                    .setInfoMsg(
                            "When MAME4droid is first run, it will create a folder structure for you on the internal memory of your Android device. This folder contains all the other folders MAME uses as well as some basic configuration files."
                                    + "Since MAME4droid does not come with game ROM files, you will need to copy them to (You can change it in options to external storage if your device allows it) '/storage/emulated/0/Android/media/com.ingcorp.webhard/roms' folder (" +
			...
			.setInfoMsg(
					"When MAME4droid is first run, it will create a folder structure for you on the internal memory of your Android device. This folder contains all the other folders MAME uses as well as some basic configuration files."
							+ "Since MAME4droid does not come with game ROM files, you will need to copy them to the '/sdcard/MAME4droid/roms' or 'Android/data/com.ingcorp.webhard/files/roms' folder (" +
